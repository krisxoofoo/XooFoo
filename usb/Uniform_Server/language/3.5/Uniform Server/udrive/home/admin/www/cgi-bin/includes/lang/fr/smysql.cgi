...
if ($run) {
  	...
  	if ($ENV{'QUERY_STRING'}eq"F"){
		...
		print <<ENDDD;
		Serveur MySQL n\'&eacute;tait pas d&eacute;marr&eacute;.
		<br />
		Mais si vous pensez que cela est &eacute;trange, cliquez sur ce <a href="$ENV{SCRIPT_NAME}?F">lien</a>
		<br />
ENDDD
  	}
}
