...
require header;
	...
	<h3>Convertir des fichiers Windows Perl</h3>
	<p>
	Si vous rencontrez des probl&egrave;mes en ex&eacute;cutant ces scripts cgi sur Unix, ce programme convertira les scripts cgi  depuis Windows au format Unix (#10#13=>#13).
	<br />
	<br />
	Instruction :
	<br />
	Apr&egrave;s ex&eacute;cution, vous pouvez coller les scripts pr&ecirc; &agrave; ex&eacute;cution sur une machine Unix depuis le dossier \\cgi-bin\\.
	<br />
	<br />
	<form name="form" action="$ENV{SCRIPT_NAME}" method="post">
	<input type="submit" name="act" value="Convertir"></font>
	</form>
	</p>
	</div>
ENDDD
