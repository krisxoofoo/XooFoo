...
if ($ENV{'QUERY_STRING'}eq"F"){
	print "
	<div id=\"main\">
 	<h2>&#187; Nettoyage du Serveur</h2>
 	<h3>Nettoyer le dossier /www/</h3>
 	<p>Le serveur a &eacute;t&eacute; nettoy&eacute; !</p>
 	</div>";
	...
	mkdir("/www/images/");
 	...
 	<h2>&#187; Nettoyage du Serveur</h2>
 	<h3>Nettoyer le dossier /www/</h3>
 	<p>Vous voulez effacer le contenu du dossier \\www\\ <br />Etes-vous s&ucirc;r ? <a href=\"$ENV{SCRIPT_NAME}?F\">Oui, je continue !</a></p>
 	</div>";
ENDDD
}
