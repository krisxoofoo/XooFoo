...
if (($ENV{HTTP_REFERER}!~/^http[s]?:\/\/localhost\/apanel/)&&($ENV{HTTP_REFERER}!~/^http[s]?:\/\/127\.0\.0\.\d+\/apanel/)){
	...
	<p>HTTP_REFERER n&#39;est pas localhost, mais '<strong>".$ENV{HTTP_REFERER}."</strong>'.<br /><br />Pour d&eacute;sactiver ce message, modifier le fichier : /home/admin/www/cgi-bin/includes/lang/en/secure.pm</p>
	</div>"; 
