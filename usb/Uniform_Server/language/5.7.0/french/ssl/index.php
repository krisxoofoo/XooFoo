...
?></title>
<meta name="Description" content="Uniform Server 5.7.0-Nano." />
...
<img src="images/translation.gif" alt="Uniform Server" width="500" height="170" alt="Translation" />
  ...
  <div id="content" style="margin-top: 0px; padding-top: 0px;" >
    ...
    <p>Bienvenue sur la page de d&#233;marrage par d&#233;faut d&#39;Uniform Server.<br />Cette page et tout autre fichier se trouvent &#224; partir du dossier racine du serveur principal &#34;/ssl/&#34;.<br />Une aide compl&#233;mentaire sur 5.7.x-Nano peut-&#234;tre trouv&#233;e sur le <a target="_1" href="http://wiki.uniformserver.com/index.php/Category:Uniform_Server_5.3-Nano">Wiki</a>.</p>
  ...
  <br />
  <p>Uniform Server est un package WAMP qui permet de faire tourner un serveur sous Windows XP, Vista ou Seven. Il est l&#233;ger, mobile, facile &#224; t&#233;l&#233;charger ou &#224; d&#233;placer, et peut &#233;galement &#234;tre utilis&#233; comme serveur de production. Les d&#233;veloppeurs utilisent &#233;galement Uniform Server pour tester leurs applications r&#233;alis&#233;es sous PHP, MySQL, Perl, ou le serveur httpd Apache.</p>
  <p>&nbsp;</p>
