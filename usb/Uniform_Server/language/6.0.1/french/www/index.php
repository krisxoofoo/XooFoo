...
<?php
// Get SSL port number
$file = fopen("$root\usr\local\apache2\conf\ssl.conf", "r") or exit("Impossibilité d'ouvrir le fichier !");
...
<?php 
   ...
   if (file_exists($filename)) { 
     print " - <a href=\"https://localhost:".$tempArray[1]."\">Afficher les pages sécurisées</a>"; 
   }
   else { 
    print ""; 
   } 
  ...
  <div id="content">
    ...
    <p>Bienvenue sur la page de démarrage par défaut d'Uniform Server.<br />Cette page et tout autre fichier se trouvent à partir du dossier racine du serveur principal "/www/". Une aide complémentaire sur 6.x-Carbo peut-être trouvée sur le <a target="_1" href="http://wiki.uniformserver.com/index.php/Category:Uniform_Server_5.3-Nano" title="Wiki Uniform Server Carbo">Wiki</a>.</p>
    <p>&nbsp;</p>
