...
# 17-12-2009 Updated for Opera USB support
###############################################################################
*/
...
print " #--------------------------------------------------------------------------------------------#\n\n";
 ...
 $Opera_name_old = get_operaUSB_exe();               # OperaUSB executable name
                                                      # New OPERAUSB executable name
...
$OPERA_name    = prompt_user(" Current OpUsb name   = $Opera_name_old  Proposed name ", $Opera_name);
...
//=============== UPDATE Opera ==========================
  ...
  file_search_replace($base_f."apps/opera/Opera.ini",$s_str,$Opera_name);

 // Rename Opera exe

 $old = "$base_f/apps/opera/$Opera_name_old";
 $new = "$base_f/apps/opera/$Opera_name";
 ...
 // Update PAC file ports
  ...
  $s_str = preg_quote($s_str,'/');        // Convert to regex format
  $s_str = '/'.$s_str.'/';                // Create regex pattern
  file_search_replace($base_f."/pac/my_hosts.pac",$s_str,$r_str);
