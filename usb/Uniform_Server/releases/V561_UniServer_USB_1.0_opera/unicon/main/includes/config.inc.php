...
define("USF_PHP_INI_DEV",       US_PHP."/php.ini_delvelopment_nano");    //PHP configuration development
...
define("USF_PHP_SWITCH_DEV_BAT",  "$base\unicon\php_dev_production\Switch_production.bat"); //Switch PHP configuration
