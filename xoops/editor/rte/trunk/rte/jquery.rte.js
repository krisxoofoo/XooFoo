    ...
    return this.each( function() {
        ...
        function toolbar() {
            var tb = $("<div class='rte-toolbar' id='toolbar-"+ element_id +"'><div>\
                ...
                <p>\
                    <a href='#' class='bold' title='bold'><img src='"+opts.media_url+"bold.gif' alt='bold' /></a>\
                    <a href='#' class='italic' title='italic'><img src='"+opts.media_url+"italic.gif' alt='italic' /></a>\
                </p>\
                <p>\
                    <a href='#' class='unorderedlist' title='unordered list'><img src='"+opts.media_url+"unordered.gif' alt='unordered list' /></a>\
                    <a href='#' class='link' title='link'><img src='"+opts.media_url+"link.png' alt='link' /></a>\
                    <a href='#' class='image' title='image'><img src='"+opts.media_url+"image.png' alt='image' /></a>\
                    <a href='#' class='disable' title='disable'><img src='"+opts.media_url+"close.gif' alt='close rte' /></a>\
                </p></div></div>");
            ...
            $('.disable', tb).click(function() {
                disableDesignMode();
                var edm = $('<a class="rte-edm" href="#" title="Enable design mode">Enable design mode</a>');
                tb.empty().append(edm);
