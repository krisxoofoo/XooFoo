...
navigation($Rb){global$Gb,$ua;echo'<h1>',$this->name(),' <span class="version">',$Gb,'</span><br /><a href="../../admin.php" id="h1" title="Return to Xoops Administration">XOOPS Administration</a><a href="http://www.adminer.org/editor/#download" id="version">',(version_compare($Gb,$_COOKIE["adminer_version"])<0?h($_COOKIE["adminer_version"]):""),'</a></h1>';if($Rb=="auth"){$Va=true;foreach((array)$_SESSION["passwords"]["server"][""]as$D=>$H){if(isset($H)){if($Va){echo"<p>\n";$Va=false;}echo"<a href='".h(auth_url("server","",$D))."'>".h($D)."</a><br>\n";}}}else{echo'<form action="" method="post">
<p class="logout">
...
';switch_lang();echo'<div id="menu">';$n->navigation($Rb);echo'</div>
