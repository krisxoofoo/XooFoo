	...
	function result(r){
		...
		switch(r.GsearchResultClass){
			...
			case 'GvideoSearch':
				arr = [
					'<div class="imageResult">',
					'<a rel="external" href="',r.url,'" title="',r.titleNoFormatting,'" class="pic" style="width:150px;height:auto;">',
					'<img src="',r.tbUrl,'" width="100%" /></a>',
					'<div class="clear"></div>','<a href="',r.originalContextUrl,'" rel="external">',r.publisher,'</a>',
					'</div>'
				];
			break;
			case 'GnewsSearch':
				arr = [
					...
					'<h2><a href="',r.unescapedUrl,'" rel="external">',r.title,'</a></h2>',
					'<p>',r.content,'</p>',
					'<a href="',r.unescapedUrl,'" rel="external">',r.publisher,'</a>',
					'</div>'
				];
			break;
		}
